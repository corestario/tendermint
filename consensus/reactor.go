...
// consensusState.
func NewReactor(consensusState *ConsensusState, fastSync bool, options ...ReactorOption) *ConsensusReactor {
...
func (conR *ConsensusReactor) SwitchToConsensus(state sm.State, blocksSynced uint64) {
